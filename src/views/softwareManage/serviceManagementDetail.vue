    ...
    <div class="full-height column">
      ...
      <div class="full-height">
        <el-table :data="tableData" height="100%" style="width: 100%">
          ...
          <el-table-column prop="serviceDetailId" label="ID" align="center"> </el-table-column>
          <el-table-column prop="serviceDetailOkQty" label="正常数量" align="center"> </el-table-column>
          <el-table-column prop="serviceDetailNoQty" label="异常数量" align="center"> </el-table-column>
          <el-table-column prop="serviceDetailStatus" label="状态" align="center"> </el-table-column>
...
export default {
  ...
  methods: {
    queryTableData() {
      ...
      this.$api.group.PageInfoSysServiceDetail(params).then((res) => {
        if (res && res.list) {
