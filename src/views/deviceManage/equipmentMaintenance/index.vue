<template>
  <div class="base-page-wrap">
    ...
    <icon-title>
      <template #title>设备保养工单</template>
      <template #right>
        <div style="display: flex; align-items: center">
          <el-button type="primary" size="mini" @click="oneKeyCheck()">一键保养</el-button>
          <el-button type="primary" size="mini" @click="batchInspection()">批量保养</el-button>
        </div>
      </template>
    </icon-title>
