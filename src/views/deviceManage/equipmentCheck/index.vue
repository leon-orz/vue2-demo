<template>
  <div class="base-page-wrap">
    ...
    <icon-title>
      <template #title>设备点检工单</template>
      <template #right>
        <div style="display: flex; align-items: center">
          <el-button type="primary" size="mini" @click="oneKeyCheck()">一键点检</el-button>
          <el-button type="primary" size="mini" @click="batchInspection()">批量点检</el-button>
        </div>
      </template>
    </icon-title>
    <div class="base-page-wrap-bd">
      ...
      >
        ...
        <el-table-column align="center" prop="orderCode" label="点检工单" />
        ...
        <el-table-column align="center" prop="stateName" label="点检状态" />
    ...
    <!-- dialog -->
    <el-dialog title="点检" :visible.sync="checkDialogShow" width="30%" @close="onCloseCheckDialog()">
      <el-select v-model="checkResult" placeholder="请选择" clearable filterable>
...
export default {
  ...
  methods: {
    ...
    oneKeyCheck() {
      ...
      this.$confirm('此操作将修改所有为点检工单, 是否继续?', '提示', {
